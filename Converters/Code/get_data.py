...
if __name__ == "__main__":
    ...
    cmd_path = Path(r"G:\lesson\diplom_project\doc\code\cmdHelper")
    # Путь к директории сохранения классов для работы с базой данных
    db_engine_path = Path(r"G:\lesson\diplom_project\doc\code\dbEngine")
    # Путь к директории сохранения классов для работы с конфигурацией
    cnf_engine_path = Path(r"G:\lesson\diplom_project\doc\code\cnfEngine")
